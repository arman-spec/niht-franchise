...
export default function OrbitingSkills() {
  ...
  const skillsConfig: SkillConfig[] = [
    { id: "html", orbitRadius: isMobile ? 60 : 80, size: isMobile ? 28 : 36, speed: 0.6, iconType: "html", phaseShift: 0, glowColor: "cyan", label: "HTML5" },
    { id: "css", orbitRadius: isMobile ? 60 : 80, size: isMobile ? 30 : 38, speed: 0.6, iconType: "css", phaseShift: (2 * Math.PI) / 3, glowColor: "cyan", label: "CSS3" },
    { id: "javascript", orbitRadius: isMobile ? 60 : 80, size: isMobile ? 28 : 36, speed: 0.6, iconType: "javascript", phaseShift: (4 * Math.PI) / 3, glowColor: "cyan", label: "JavaScript" },

    { id: "react", orbitRadius: isMobile ? 105 : 140, size: isMobile ? 36 : 45, speed: -0.35, iconType: "react", phaseShift: 0, glowColor: "purple", label: "React" },
    { id: "node", orbitRadius: isMobile ? 105 : 140, size: isMobile ? 34 : 42, speed: -0.35, iconType: "node", phaseShift: (2 * Math.PI) / 3, glowColor: "purple", label: "Node.js" },
    { id: "tailwind", orbitRadius: isMobile ? 105 : 140, size: isMobile ? 30 : 38, speed: -0.35, iconType: "tailwind", phaseShift: (4 * Math.PI) / 3, glowColor: "purple", label: "Tailwind CSS" },
  ];
  ...
  if (!mounted) return <div className="w-[260px] h-[260px]" />;
  ...
  return (
    <main className="w-full flex items-center justify-center overflow-hidden">
      <div
        className="
              relative 
              w-[90vw] h-[90vw]          /* mobile: full responsive circle */
              sm:w-[60vw] sm:h-[60vw]    /* tablet */
              md:w-[45vw] md:h-[45vw]    /* small laptop */
              lg:w-[420px] lg:h-[420px]  /* desktop fixed size */
              max-w-[420px] max-h-[420px]
              flex items-center justify-center
            "
      >
        {/* Glowing Orbit Paths */}
        <GlowingOrbitPath radius={isMobile ? 60 : 80} glowColor="cyan" />
        <GlowingOrbitPath radius={isMobile ? 105 : 140} glowColor="purple" animationDelay={0.5} />

        {/* Central Icon */}
        <div
          className="relative w-16 h-16 rounded-full bg-gray-900/80 backdrop-blur-sm flex items-center justify-center text-white font-bold text-lg cursor-pointer hover:scale-110 transition-transform duration-300"
        ...
        {skillsConfig.map((skill) => {
          ...
          return (
            ...
            >
              <div className="relative w-full h-full p-2 bg-gray-800/90 rounded-full flex items-center justify-center">
